...
import com.lapostal.security.jwt.JwtAuthEntryPoint;
import com.lapostal.security.jwt.JwtAuthTokenFilter;
...
public class WebSecurityConfig  extends WebSecurityConfigurerAdapter{
	    ...
	    protected void configure(HttpSecurity http) throws Exception {
	        http.cors().disable()
	        	.csrf().disable().
	                authorizeRequests()	                
	                .antMatchers("/authentification/api/**","/index.html","/**", "/resources/templates/index.html").permitAll()
