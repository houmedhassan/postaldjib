...
let NouveaucolisComponent = class NouveaucolisComponent {
    ...
    save(colisForm) {
        ...
        let amontsection = colisForm['reference'].substring(0, 2);
        let numbersection = Number(colisForm['reference'].substring(2, 11));
        let avalsection = colisForm['reference'].substring(11, 14);
        let letters = /^[A-Za-z]+$/;
        ...
        if (!amontsection.match(letters) || amontsection.length != 2 || !numbersection || !avalsection.match(letters) || avalsection.length != 2) {
            ...
            this.httpClient.get(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_9__["environment"].url + "/api/postal/envoi/reference?reference=" + colisForm['reference'], { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
                    'Authorization': 'Bearer ' + this.tokenStorage.getToken()
                })
            }).subscribe(response => {
                if (response['reference'] == null) {
                    ...
                    this.showConfirm("Numero de reference existante", "Veuillez fourni un nouveau numero de reference, car ce dernier existe !!! ");
                }
                //this.showSuccess("Vous avez enregistrer avec success votre colis  !!! ")
            }, error => {
                this.showError(" une erreur c'est produit et le système n'a pas enregitré votre colis - La raison est voici : " + error.getMessage());
    ...
    showConfirm(title, detail) {
        ...
        this.messageService.add({ key: 'c', sticky: true, severity: 'warn', summary: title, detail: detail });
    }
    onConfirm() {
        this.messageService.clear('c');
        this.colisForm.patchValue({ reference: undefined });
    }
};
...
let NouveaurecommandeComponent = class NouveaurecommandeComponent {
    ...
    save(recommandeForm) {
        let amontsection = recommandeForm['reference'].substring(0, 2);
        let numbersection = Number(recommandeForm['reference'].substring(2, 11));
        let avalsection = recommandeForm['reference'].substring(11, 14);
        let letters = /^[A-Za-z]+$/;
        if (!amontsection.match(letters) || amontsection.length != 2 || !numbersection || !avalsection.match(letters) || avalsection.length != 2) {
            this.showConfirm("Numero de reference erronné", "Une reference doit contenir deux lettre en amant suivi de 9 chiffre et avec deux lettre à la fin !!!");
        }
        else {
            this.httpClient.get(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_9__["environment"].url + "/api/postal/envoi/reference?reference=" + recommandeForm['reference'], { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
                    'Authorization': 'Bearer ' + this.tokenStorage.getToken()
                })
            }).subscribe(response => {
                if (response == null) {
    ...
    onConfirm() {
        this.messageService.clear('c');
        this.recommandeForm.patchValue({ reference: undefined });
    }
};
...
let TableaubordreceptionComponent = class TableaubordreceptionComponent {
    ...
    ngOnInit() {
        ...
        this.httpClient.get(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_9__["environment"].url + "/api/postal/reception/tableau/bord2", { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
                'Authorization': 'Bearer ' + this.tokenStorage.getToken()
            })
        }).subscribe((response) => {
            console.log(response);
...
let NouveaurecommandereceptionComponent = class NouveaurecommandereceptionComponent {
    ...
    save(recommandeForm) {
        this.httpClient.get(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_10__["environment"].url + "/api/postal/reception/reference?reference=" + recommandeForm['reference'], { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                'Authorization': 'Bearer ' + this.tokenStorage.getToken()
            })
        }).subscribe(response => {
            if (response == null) {
...
let NouveaucolisreceptionComponent = class NouveaucolisreceptionComponent {
    ...
    save(colisForm) {
        ...
        const regex = /\d/;
        let amontsection = colisForm['reference'].substring(0, 2);
        let numbersection = colisForm['reference'].substring(3, 12);
        let avalsection = colisForm['reference'].substring(12, 14);
        if (typeof (amontsection) != 'number' || typeof (numbersection) != 'string' || typeof (avalsection) != 'number') {
            this.showConfirm("Numero de reference erronné", "Une reference doit contenir deux lettre en amant suivi de 9 chiffre et avec deux lettre à la fin !!!");
        }
        else {
            this.httpClient.get(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_10__["environment"].url + "/api/postal/reception/reference?reference=" + colisForm['reference'], { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                    'Authorization': 'Bearer ' + this.tokenStorage.getToken()
                })
            }).subscribe(response => {
                if (response == null) {
...
/* harmony import */ var _auth_models_login_info__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../auth/models/login-info */ "u2iu");
/* harmony import */ var _auth_token_storage_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../auth/token-storage.service */ "dZLz");
...
let ProfilComponent = class ProfilComponent {
    constructor(messageService, formBuilder, authService, tokenStorage, httpClient) {
        this.messageService = messageService;
        this.formBuilder = formBuilder;
    ...
    ngOnInit() {
        /*this.userService.getUserBoard().subscribe(
          ...
          */
        this.httpClient.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].url + '/authentification/api/profil', { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
                'Authorization': 'Bearer ' + this.tokenStorage.getToken()
            })
        })
            .subscribe(res => {
    ...
    updatePassword(value) {
        ...
        if (value['confirmationpassword'] != value['password']) {
            ...
            this.httpClient.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].url + '/authentification/api/update/password', value, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
                    'Authorization': 'Bearer ' + this.tokenStorage.getToken()
                })
            })
                .subscribe(res => {
                console.log(res);
                this.loginInfo = new _auth_models_login_info__WEBPACK_IMPORTED_MODULE_9__["AuthLoginInfo"](this.profil['username'], value['password']);
                ...
                this.showSuccess("Vous avez mis à jour avec success votre mot de passe. Merci !");
                this.passwordForm.reset();
                //this.profil = res;
            }, err => {
                if (err.status === 401) {
                    this.showError(" Vous n'etes pas autorisé à effectuer cette modification, veuillez vous deconnectez et vous reconnectez");
                }
                else {
                    this.showError("message d'erreur " + err.message);
                }
            });
        }
    }
...
let EditreceptionComponent = class EditreceptionComponent {
    ...
    save(emsForm) {
        ...
        if (this.receptiondto.reference == emsForm['reference']) {
            ...
            this.httpClient.get(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_10__["environment"].url + "/api/postal/reception/reference?reference=" + emsForm['reference'], { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                    'Authorization': 'Bearer ' + this.tokenStorage.getToken()
                })
            }).subscribe(response => {
                if (response == null) {
   ...
   */
    ...
    onConfirm() {
        this.messageService.clear('c');
        this.emsForm.patchValue({ reference: undefined });
    }
};
...
let NouveauesuuqComponent = class NouveauesuuqComponent {
    ...
    save(esuuqForm) {
        ...
        this.showConfirm("Numero de reference erronné", "Une reference doit contenir deux lettre en amant suivi de 9 chiffre et avec deux lettre à la fin !!!");
          ...
          */
        this.httpClient.get(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_10__["environment"].url + "/api/postal/reception/reference?reference=" + esuuqForm['reference'], { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                'Authorization': 'Bearer ' + this.tokenStorage.getToken()
            })
        }).subscribe(response => {
            if (response == null) {
   ...
   */
    ...
    onConfirm() {
        this.messageService.clear('c');
        this.esuuqForm.patchValue({ reference: undefined });
    }
};
...
let RapportsventeComponent = class RapportsventeComponent {
    ...
    ngOnInit() {
        ...
        this.httpClient.post(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_10__["environment"].url + "/api/postal/vente/rapports", this.rapportFormObject, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                'Authorization': 'Bearer ' + this.tokenStorage.getToken()
            })
        }).subscribe(response => {
            console.log(response);
            this.rapportVentes = response;
        }, error => {
        });
    }
    /**
...
let NouveauventeComponent = class NouveauventeComponent {
    ...
    ngOnInit() {
        this.typepaiement = { code: 'CASH', name: 'CASH' };
        this.typepaiements = [];
        this.typepaiements.push({ code: 'CASH', name: 'CASH' });
        this.typepaiements.push({ code: 'CHEQUE', name: 'CHEQUE' });
        this.typepaiements.push({ code: 'AUTRES', name: 'AUTRES' });
        this.venteForm = this.formBuilder.group({
            //'nom': new FormControl('', Validators.required),
        ...
        this.httpClient.get(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_10__["environment"].url + "/api/postal/vente/parametrage/all", { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
            ...
            this.showError(" une erreur c'est produit  - La raison est voici : " + error.message);
        });
...
let TableaubordstocksComponent = class TableaubordstocksComponent {
    ...
    ngOnInit() {
        ...
        this.httpClient.get(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_9__["environment"].url + "/api/postal/reception/stock/tableau/bord1", { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
                'Authorization': 'Bearer ' + this.tokenStorage.getToken()
            })
        }).subscribe((response) => {
            console.log(response);
    ...
    save(emsForm) {
        ...
        if (!amontsection.match(letters) || amontsection.length != 2 || !numbersection || !avalsection.match(letters) || avalsection.length != 2) {
            ...
            if (this.envoidto.reference == emsForm['reference']) {
                ...
                this.httpClient.get(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_9__["environment"].url + "/api/postal/envoi/reference?reference=" + emsForm['reference'], { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
                        'Authorization': 'Bearer ' + this.tokenStorage.getToken()
                    })
                }).subscribe(response => {
                    if (response == null) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NouveauordinaireComponent", function() { return NouveauordinaireComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_nouveauordinaire_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./nouveauordinaire.component.html */ "Vwg9");
/* harmony import */ var _nouveauordinaire_component_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./nouveauordinaire.component.css */ "ixt6");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common/http */ "tk/3");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/router */ "tyNb");
...
let NouveauordinaireComponent = class NouveauordinaireComponent {
    constructor(formBuilder, messageService, httpClient, router, tokenStorage) {
        this.formBuilder = formBuilder;
        this.messageService = messageService;
        this.httpClient = httpClient;
...
NouveauordinaireComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"] },
    { type: primeng_api__WEBPACK_IMPORTED_MODULE_7__["MessageService"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"] },
...
NouveauordinaireComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
...
const environment = {
    production: true,
    url: ''https://lapostedjib.herokuapp.com':8845'
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OrdinaireenvoiComponent", function() { return OrdinaireenvoiComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_ordinaireenvoi_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./ordinaireenvoi.component.html */ "j+Qn");
/* harmony import */ var _ordinaireenvoi_component_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ordinaireenvoi.component.css */ "Jj24");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common/http */ "tk/3");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var primeng_api__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! primeng/api */ "7zfz");
...
let OrdinaireenvoiComponent = class OrdinaireenvoiComponent {
    constructor(messageService, httpClient, router, tokenStorage) {
        this.messageService = messageService;
        this.httpClient = httpClient;
        this.router = router;
    ...
    ngOnInit() {
         ...
         *  -- REQUETE POUR RECUPERER LA LISTE DES TYPE D ARTICLE
         */
        this.httpClient.get(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_8__["environment"].url + "/api/postal/envoi/ordinaire", { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
                'Authorization': 'Bearer ' + this.tokenStorage.getToken()
            })
        }).subscribe(response => {
            this.listems = response;
            ...
            this.showWarn("Les articles Ordinaire  n'ont pas pu etre chargé, Voici la raison " + error.getMessage());
        });
    }
    /**
     * Editer EMS - Redirection vers la page de edition d'un nouveau ems
...
OrdinaireenvoiComponent.ctorParameters = () => [
    { type: primeng_api__WEBPACK_IMPORTED_MODULE_6__["MessageService"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] },
    { type: src_app_auth_token_storage_service__WEBPACK_IMPORTED_MODULE_7__["TokenStorageService"] }
];
OrdinaireenvoiComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
...
let TableaubordComponent = class TableaubordComponent {
    ...
    ngOnInit() {
        ...
        this.httpClient.get(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_9__["environment"].url + "/api/postal/envoi/tableau/bord2", { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
                'Authorization': 'Bearer ' + this.tokenStorage.getToken()
            })
        }).subscribe((response) => {
            console.log(response);
...
/* harmony import */ var _apps_stocks_tableaubordstocks_tableaubordstocks_component__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(/*! ./apps/stocks/tableaubordstocks/tableaubordstocks.component */ "L7Y2");
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forRoot([
                { path: 'login', component: _pages_app_login_component__WEBPACK_IMPORTED_MODULE_9__["AppLoginComponent"] },
                {
                    ...
                    children: [
                        ...
                        { path: 'profil', component: _profil_profil_component__WEBPACK_IMPORTED_MODULE_47__["ProfilComponent"] },
                        /**
                        ...
                        { path: 'gestion/envoi/ordinaire?a06057302f859b52fc7ed77ef5dfb5e5ad2e6e2cc9187d25510f74499d0c1dab', component: _apps_envoi_ordinaireenvoi_ordinaireenvoi_component__WEBPACK_IMPORTED_MODULE_45__["OrdinaireenvoiComponent"] },
                        { path: 'gestion/envoi/ordinaire/nouveau?a06057302f859b52fc7ed77ef5dfb5e5ad2e6e2cc9187d25510f74499d0c1dab', component: _apps_envoi_ordinaireenvoi_nouveauordinaire_nouveauordinaire_component__WEBPACK_IMPORTED_MODULE_46__["NouveauordinaireComponent"] },
                        ...
                        { path: 'gestion/reception/livraison/tableau de bord?ef2e7680bc9ac5e77c16e54b7491fae317e766113a4fe65fdaa3270e80bbc4ab', component: _apps_stocks_tableaubordstocks_tableaubordstocks_component__WEBPACK_IMPORTED_MODULE_44__["TableaubordstocksComponent"] },
...
let NouveauordinairereceptionComponent = class NouveauordinairereceptionComponent {
    ...
    save(ordinaireForm) {
        ...
        this.showConfirm("Numero de reference erronné", "Une reference doit contenir deux lettre en amant suivi de 9 chiffre et avec deux lettre à la fin !!!");
          ...
          */
        this.httpClient.get(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_10__["environment"].url + "/api/postal/reception/reference?reference=" + ordinaireForm['reference'], { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
                'Authorization': 'Bearer ' + this.tokenStorage.getToken()
            })
        }).subscribe(response => {
            if (response == null) {
    ...
    onConfirm() {
        this.messageService.clear('c');
        this.ordinaireForm.patchValue({ reference: undefined });
    }
};
